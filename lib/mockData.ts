...
export const MOCK_PACKAGING_REQUESTS: PackagingRequest[] = [
  // ── 대용량 테스트용 더미 (패키지 10개, 상품 28개) ─────────────────────────
  {
    requestId: '2601121705000001',
    userId: 'testuser_large_data',
    packageNumber: 'LARGE_TEST_PKG',
    packageNumberAlias: '대용량테스트9999',
    packages: [
      {
        packageCode: 'PKG_A001',
        packageAlias: '대용량A001',
        packagingOption: '합포장',
        packageList: ['구성품만'],
        userNote: 'the signed album plus all the pobs and the signed polaroid. please handle with care.',
        productList: [
          { name: '[PRE-ORDER] AESPA - ARMAGEDDON (THE 1ST ALBUM) [NINGNING Ver.]', qty: 5 },
          { name: '[PRE-ORDER] AESPA - ARMAGEDDON (THE 1ST ALBUM) [WINTER Ver.]', qty: 3 },
          { name: '에스파 아르마게돈 포토카드 세트 (닝닝/윈터/지젤/카리나)', qty: 10, isPob: true },
        ],
        storageLocation: 'A-01-01',
        adminRecord: '배송 대행 주문 :testA001 포카앨범 18EA, 포토카드 30EA',
      },
      {
        packageCode: 'PKG_A002',
        packageAlias: '대용량A002',
        packagingOption: '구성품만',
        packageList: ['구성품만', 'POB만'],
        productList: [
          { name: '[PRE-ORDER/EVENT] 82MAJOR - 2026 SPEC CALENDAR [우리의 계절]', qty: 2 },
          { name: '82MAJOR 특전 폴라로이드 (사인)', qty: 4, isPob: true },
          { name: '82MAJOR 특전 포카 (랜덤)', qty: 4, isPob: true },
        ],
        storageLocation: 'A-01-02',
        adminRecord: '배송 대행 주문 :testA002 CD앨범 2EA, 특전 포카 8EA',
      },
      {
        packageCode: 'PKG_A003',
        packageAlias: '대용량A003',
        packagingOption: '합포장',
        packageList: ['전체 (앨범, 포스터, 포토북 제외)'],
        productList: [
          { name: '[12/11 1:1 영상통화 EVENT] 루네이트 (LUN8) - 2nd SINGLE ALBUM [LOST] (DAY Ver. / LIGHT Ver.)', qty: 0, preOptionQty: 3 },
          { name: '루네이트 특전 구성품 세트 (포토카드 + 브로마이드)', qty: 3, isPob: true },
          { name: 'Card-shaped photos printed with portraits of all members', qty: 5 },
        ],
        storageLocation: 'B-02-03',
        adminRecord: '배송 대행 주문 :testA003 사인앨범 3EA 포함',
      },
      {
        packageCode: 'PKG_A004',
        packageAlias: '대용량A004',
        packagingOption: '구성품만',
        packageList: ['구성품만'],
        productList: [
          { name: 'IVE - ELEVEN (1ST SINGLE ALBUM) [WONYOUNG Ver.] (Limited Edition)', qty: 7 },
          { name: 'IVE ELEVEN 특전 포카 (원영/유진/레이/리즈/가을/이서)', qty: 7, isPob: true },
          { name: 'IVE ELEVEN 포스터 (접지)', qty: 7, isPob: true },
        ],
        storageLocation: 'C-03-05',
        adminRecord: '배송 대행 주문 :testA004 앨범 7EA, 특전 14EA',
      },
      {
        packageCode: 'PKG_A005',
        packageAlias: '대용량A005',
        packagingOption: 'POB만',
        packageList: ['POB만'],
        productList: [
          { name: 'LE SSERAFIM - UNFORGIVEN (1ST STUDIO ALBUM) [YUNJIN Ver.]', qty: 0, preOptionQty: 2 },
          { name: 'LE SSERAFIM UNFORGIVEN 위버스 앨범 POB 포카 세트', qty: 5, isPob: true },
          { name: 'LE SSERAFIM 사인 폴라로이드 (공식 MD)', qty: 2, isPob: true },
        ],
        storageLocation: 'C-03-06',
        adminRecord: '배송 대행 주문 :testA005 위버스앨범 2EA, POB 7EA',
      },
      {
        packageCode: 'PKG_A006',
        packageAlias: '대용량A006',
        packagingOption: '합포장',
        packageList: ['구성품만', '전체 (앨범, 포스터, 포토북 제외)'],
        userNote: 'all pobs should be inside the album sleeve, please wrap each album separately.',
        productList: [
          { name: 'SEVENTEEN - SPILL THE FEELS (12TH MINI ALBUM) [CARAT Ver.]', qty: 4 },
          { name: '세븐틴 SPILL THE FEELS 특전 포카 (랜덤 / 13멤버)', qty: 8, isPob: true },
          { name: 'Film (Instant photo, 8.6cm x 5.4cm)', qty: 4, isPob: true },
        ],
        storageLocation: 'D-04-02',
        adminRecord: '배송 대행 주문 :testA006 앨범 4EA, 특전 12EA',
      },
      {
        packageCode: 'PKG_A007',
        packageAlias: '대용량A007',
        packagingOption: '구성품만',
        packageList: ['구성품만'],
        productList: [
          { name: 'STRAY KIDS - ★★★★★ (5-STAR) (7TH MINI ALBUM) [LIMITED Ver.]', qty: 6 },
          { name: '스트레이키즈 5-STAR 한정판 북클릿 (100P 포토북)', qty: 6, isPob: true },
          { name: '스트레이키즈 5-STAR 특전 포카 (8멤버 랜덤)', qty: 6, isPob: true },
          { name: 'Lyric card (set of 8)', qty: 6, isPob: true },
        ],
        storageLocation: 'D-04-07',
        adminRecord: '배송 대행 주문 :testA007 한정판 앨범 6EA, 특전 18EA',
      },
      {
        packageCode: 'PKG_A008',
        packageAlias: '대용량A008',
        packagingOption: '합포장',
        packageList: ['전체 (앨범, 포스터, 포토북 제외)'],
        productList: [
          { name: 'NewJeans - OMG (2ND SINGLE ALBUM) [BUNNIES CLUB Ver.]', qty: 8 },
          { name: 'NewJeans OMG 특전 버니즈클럽 멤버십 카드', qty: 8, isPob: true },
          { name: 'NewJeans OMG 포토카드 세트 (5멤버 랜덤)', qty: 8, isPob: true },
        ],
        storageLocation: 'E-05-01',
        adminRecord: '배송 대행 주문 :testA008 버니즈클럽 앨범 8EA, 특전 16EA',
      },
      {
        packageCode: 'PKG_A009',
        packageAlias: '대용량A009',
        packagingOption: 'POB만',
        packageList: ['POB만', '구성품만'],
        userNote: 'fragile items, please use bubble wrap.',
        productList: [
          { name: 'BTS - THE BEST (JAPANESE COMPILATION ALBUM) [Regular Edition]', qty: 0, preOptionQty: 1 },
          { name: 'BTS THE BEST 일반반 포카 세트 (7멤버 전원)', qty: 3, isPob: true },
          { name: 'BTS 공식 아크릴 스탠드 (미니 7종 세트)', qty: 1, isPob: true },
          { name: 'Folded poster (B2 size, 51.5cm x 72.8cm)', qty: 1, isPob: true },
        ],
        storageLocation: 'E-05-09',
        adminRecord: '배송 대행 주문 :testA009 일본반 앨범 1EA, POB 5EA',
      },
      {
        packageCode: 'PKG_A010',
        packageAlias: '대용량A010',
        packagingOption: '구성품만',
        packageList: ['구성품만'],
        productList: [
          { name: '이달의 소녀 LOONA - [+ +] (1ST MINI ALBUM) [HeeJin & HyunJin Ver.]', qty: 10 },
          { name: '이달의 소녀 1/3 포카 세트 (희진/현진/하슬/여진 랜덤)', qty: 10, isPob: true },
          { name: 'LOONAVERSE 공식 스티커 시트 (4종)', qty: 10, isPob: true },
          { name: 'HeeJin & HyunJin 유닛 포스터 (A3, non-folded)', qty: 5, isPob: true },
        ],
        storageLocation: 'F-06-03',
        adminRecord: '배송 대행 주문 :testA010 미니앨범 10EA, 특전 25EA',
      },
    ],
    requestedAt: '2026-03-13',
    daysSince: '(D+0)',
    adminMemo: '대용량 스크롤 테스트용 더미 데이터 (패키지 10개, 상품 28개)',
    status: 'started',
  },
